...
export const metadata = {
  ...
  date: "2023-08-05", // Custom property if needed for internal use
  openGraph: {
    title: "Vietnam: Land of Strong Coffee and Risky Crosswalks",
    description: "Reflecting on my experience horsepacking with ___ in Mongolia.",
    images: [
      {
        url: "/images/62b1ca5f-d849-41a7-a83e-42ca04b3b47c.jpg",
  ...
  keywords: ["travel", "vietnam", "guide"], // Additional SEO keywords
};

<JsonLd
  type="BlogPosting"
  url={`https://yourwebsite.com/blog/vietnam-strong-coffee`}
  title={metadata.title}
  description={metadata.description}
  image={`https://yourwebsite.com${metadata.image}`}
