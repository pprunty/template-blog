...
export const metadata = {
  title: "Hosting a LLM for Free with Ollama",
  image: `/images/ollama-dark.png`,
  ...
  openGraph: {
    ...
    url: `${SITE_URL}/blog/ollama`,
    images: [
      {
        url: `${SITE_URL}/images/ollama-dark.png`,
  ...
  twitter: {
    ...
    image: `${SITE_URL}/images/ollama-dark.png`,
  },
  keywords: [
    "ai",
    "saas",
...
![An awesome image](/images/ollama-dark.png)
