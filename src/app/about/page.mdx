...
* Developed [Samwise](https://github.com/pprunty/samwise), a high-performance blog template built with [NextJS 15](https://nextjs.org/). This open-source project combines minimalist design with robust features. Read about its development journey in [New Blog. Who Dis?](/blog/new-blog-who-dis)

# CV [#cv]

For a comprehensive overview of my professional journey, my full CV is available [here](/downloads/pprunty_CV.pdf).
...
<Link
href="https://www.youtube.com/channel/UCx8iHEGQMyeInLgPQ81-EJA?sub_confirmation=1"
>
<MemoizedImage
src={"/images/projects/jigsaw-presents.webp"}
alt={"Link to Jigsaw Presents YouTube Channel"}
width={620}
height={500}
loading="lazy"
focusable={false}
...
[Samwise](https://samwise-v2-template.vercel.app/) is an open-source, high-performance digital blog and portfolio template designed for developers and content
creators. Key features include:

- Modern, minimalistic, responsive design
- Built with Next.js 15
- Optimized performance
- Automated SEO optimization
- Easy customization via CRUD APIs for creating, deleting, editing blog posts and website SEO configuration
- Markdown and MDX support for editing blog posts with interactive JSX components

<Link
href="https://samwise-v2-template.vercel.app/"
>
<MemoizedImage
src={"/images/projects/samwise-v2.webp"}
alt={"samwise Logo"}
width={620}
height={500}
loading="lazy"
