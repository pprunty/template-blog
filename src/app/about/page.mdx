...
* Developed [Samwise](https://github.com/pprunty/samwise), a high-performing Next.js 15 digital blog platform that provides automated SEO, developer-friendly CRUD APIs for content management, and Markdown/MDX support for creating interactive blog posts with customized web components.
...
A curated collection of books that challenge, inspire, and broaden perspectives:
