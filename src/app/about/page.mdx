...
Fast-forward some years, and I now hold a MSc. in High-Performance Computing. I learned the value of GPUs, low-level programming, and parallel computing before the likes of Bitcoin and ChatGPT, which leverage these technologies, took shape.
...
Today, I’ve found my niche as a full-stack software engineer, designing web applications that provide healthcare solutions and improve people’s lives. It’s a role where my passions for storytelling, problem-solving, and innovation converge in a meaningful way.
...
* **MSc. High-Performance Computing**: Graduated with First Class Honors in a MSc. in High-Performance Computing (HPC) from Trinity College Dublin in 2020. [Learn more about HPC here](/blog/high-performance-computing).
...
![Jigsaw Presents Logo](/images/projects/jigsaw-presents.png)

## blog.v2

![blog.v2 Logo](/images/projects/blog-v2.png)
