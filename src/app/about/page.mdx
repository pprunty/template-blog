...
* Created [blog.v2](https://github.com/pprunty/blog.v2), a high-performance, minimalistic and feature-rich open-sourced blog template built with [NextJS 14](https://nextjs.org/blog/next-14). The inspiration behind creating this template is detailed in this [article](./blog/new-blog-who-dis).
