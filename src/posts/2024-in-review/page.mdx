...
export const metadata = {
  ...
  image: '/images/2024-in-review/2024-in-review.webp',
  date: '2024-12-04',
  ...
  description: "A look back on a transformative year filled with achievements, insights, and pivotal trends across technology, outdoor pursuits, and entrepreneurial ventures—reflecting on lessons learned and charting the path forward for the year ahead.",
    ...
    images: [
      {
        url: 'http://localhost:3000/images/2024-in-review/2024-in-review.webp',
        alt: '2024 in Review'
      }
    ],
    type: 'article',
  ...
  twitter: {
    ...
    title: '2024 in Review',
  description: "A look back on a transformative year filled with achievements, insights, and pivotal trends across technology, outdoor pursuits, and entrepreneurial ventures—reflecting on lessons learned and charting the path forward for the year ahead.",
    image: 'http://localhost:3000/images/2024-in-review/2024-in-review.webp'
  },
  keywords: [
    'yearly review',
    'artificial intelligence',
